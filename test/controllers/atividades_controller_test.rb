...
class AtividadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create atividade" do
    assert_difference("Atividade.count") do
      post atividades_url, params: { atividade: { descricao: @atividade.descricao, end_time: @atividade.end_time, nome: @atividade.nome, start_time: @atividade.start_time } }
    end
  ...
  test "should update atividade" do
    patch atividade_url(@atividade), params: { atividade: { descricao: @atividade.descricao, end_time: @atividade.end_time, nome: @atividade.nome, start_time: @atividade.start_time } }
